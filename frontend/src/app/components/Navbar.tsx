...
const Navbar: React.FC = () => {
  ...
  const homeUrl = isAuthenticated ? "/pages/home" : "/";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <NavLink href="/pages/about" isActive={isActive("/pages/about")}>
              Tentang
            </NavLink>
            ...
            <div className="relative" ref={profileMenuRef}>
              <button
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center transition-colors border border-gray-600 hover:border-yellow-400 overflow-hidden bg-gray-700"
                aria-label="Profile"
              >
                {isAuthenticated && user?.profile_picture ? (
                  ...
                  <HiUserCircle className="w-6 h-6 text-gray-300" />
                )}
              </button>
              {showProfileMenu && (
              ...
              {isAuthenticated ? (
                <div className="pt-3 mt-3 border-t border-gray-700">
                  ...
                  <Link
                    ...
                    onClick={() => setShowMobileMenu(false)}
                  >
                    <FaUserEdit className="w-5 h-5 text-blue-400" />
