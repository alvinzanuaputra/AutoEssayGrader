              ...
              {isAuthenticated ? (
                <div className="pt-3 mt-3 border-t border-gray-700">
                  <div className="px-4 py-3 bg-gray-800/50 rounded-lg mb-2">
                    <div className="flex items-center space-x-3">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center text-white text-lg font-bold shadow-lg">
